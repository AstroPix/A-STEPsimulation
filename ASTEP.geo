...
SL.Color 2
SL.Visibility 0
SL.Shape BOX {.5*LayerLength} {.5*LayerWidth} {.5*(PCBThickness+QCThickness)}
...
BusBar.Visibility 1
BusBar.Color 46
BusBar.Shape BOX {.5*BBWidth} {.5*QCWidth} {.5*BBThickness}
BusBar.Position {BBOffset+.5*BBWidth} {0.} {.5*ChipThickness}
...
SiSubstrate.Color 4
SiSubstrate.Shape BOX {.5*QCLength} {.5*QCWidth} {.5*ChipThickness}
...
APS.Visibility 1
APS.Color 7
APS.Shape BOX {.5*ActiveAreaLength} {.5*ActiveAreaWidth} {.5*DepletionDepth}
...
For I 2 {-.5*QCWidth+.5*ActiveAreaWidth+Guardring} {ActiveAreaWidth+StructuralPitchW}
	For J 2 {-.5*QCLength+.5*ActiveAreaLength+DigitalPeriphery} {ActiveAreaLength+StructuralPitchL}
		APS.Copy APS_%I_%J
    	APS_%I_%J.Position $J {-$I} {.5*(ChipThickness-DepletionDepth)}
...
PCBoard1.Shape Box {.5*PCBLength} {.5*LayerWidth} {.5*PCBThickness}
PCBoard1.Position {.5*(LayerLength-PCBLength)} 0.0 {-.5*QCThickness}
PCBoard1.Mother SL
...
PCBoard1_Screw1.Position {.5*PCBLength - PCB_Screw_Offset_Length} {-.5*LayerWidth + PCB_Screw_Offset_Width} 0
...
PCBoard1_Screw2.Position {.5*PCBLength - PCB_Screw_Offset_Length} {.5*LayerWidth - PCB_Screw_Offset_Width} 0
...
PCBoard2.Shape Box {.5*FEELength} {.5*LayerWidth} {.5*PCBThickness}
PCBoard2.Position {.5*(FEELength-LayerLength)} 0.0 {-.5*QCThickness}
PCBoard2.Mother SL
...
PCBoard2_Screw1.Position {-.5*FEELength + PCB_Screw_Offset_Length} {-.5*LayerWidth + PCB_Screw_Offset_Width} 0
...
PCBoard2_Screw2.Position {-.5*FEELength + PCB_Screw_Offset_Length}  {.5*LayerWidth - PCB_Screw_Offset_Width} 0
...
PCBoard3.Shape Box {.5*PCBSideL} {.5*PCBRightW} {.5*PCBThickness}
PCBoard3.Position { -.5*LayerLength+FEELength+.5*PCBSideL} {.5*(LayerWidth-PCBRightW)} {-.5*QCThickness}
PCBoard3.Mother SL
...
PCBoard4.Shape Box {.5*PCBSideL} {.5*PCBLeftW} {.5*PCBThickness}
PCBoard4.Position { -.5*LayerLength+FEELength+.5*PCBSideL} {-.5*(LayerWidth-PCBLeftW)} {-.5*QCThickness}
PCBoard4.Mother SL
